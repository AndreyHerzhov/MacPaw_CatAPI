...
export function createVotingMarkup(img,id) {
    refs.main.innerHTML = `
    <div class="main-container_voting">
            ...
            <div class="main-container_voting-form">
                    ...
                    <button type="button" id="smile" class="voting-button_links search-form_button">
                    ...
                    <button type="button" id="heart" class="voting-button_links search-form_button">
                        ...
                        <button type="button" id="sad" class="voting-button_links search-form_button">
                    ...
                    <div class="main-container_voting-data">
                            ...
                            <div class="voting-image_card">
                                ...
                                <div class="voting-image_button-wrapper">
                                    <button data-src="${img}" id=${id} type="button" class="voting-image_button-smile voting-button">
                                        <svg class="icon-smile" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button data-src="${img}" id=${id} type="button" class="voting-image_button-heart voting-button">
                                        <svg class="icon-heart" width="30" height="26" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <button data-src="${img}" id=${id} type="button" class="voting-image_button-sad voting-button">
                                        <svg class="icon-sad" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="main-container_breeds-data">
                            ...
                            <div class="breeds-button_wrapper">
                                ...
                                <select class="filter-button_breeds" name="Page_limit" id="limit">
                                    ...
                                    <option value="10" selected="selected">Limit: 10</option>
